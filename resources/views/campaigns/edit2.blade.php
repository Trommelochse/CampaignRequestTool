...
<div class="wrapper">
  <form method="POST" action="{{route('updateLocalisation', $campaign->id)}}" data-abide novalidate  >
    <fieldset class="borderFieldset">
      ...
      <div class="row">
        ...
        <div class="large-3 columns">
          <input class="revealer" type="checkbox" id="campaignLogo" name="logo" value=1 {{ $campaign->logo ? 'checked' : '' }}>
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <div class="row">
            <div class="large-3 columns">
              <input class="revealer" id="marketDK" name="dk" type="checkbox" value=1 {{ $campaign->dk ? 'checked' : '' }}>
          ...
          <div class="row">
            <div class="large-3 columns ">
              <input class="revealer" id="marketSE" name="sv" type="checkbox" value=1 {{ $campaign->sv ? 'checked' : '' }}>
          ...
          <div class="row">
            <div class="large-3 columns">
              <input class="revealer" id="marketNO" name="no" type="checkbox" value=1 {{ $campaign->no ? 'checked' : '' }}>
          ...
          <div class="row">
            <div class="large-3 columns">
              <input class="revealer" id="marketFI"  name="fi" type="checkbox" value=1 {{ $campaign->fi ? 'checked' : '' }}>
          ...
          <div class="row">
            <div class="large-3 columns">
              <input class="revealer" id="marketDE" name="de" type="checkbox" value=1 {{ $campaign->de ? 'checked' : '' }}>
          ...
          <div class="row">
            <div class="large-3 columns">
              <input class="revealer" id="en" name="en" type="checkbox" value=1 {{ $campaign->en ? 'checked' : '' }}>
              <label for="marketEN">EN</label>
            </div>
            <div class="large-9 columns hiddenField">
              <label for="logoTextEN">EN Logo Text Translation</label>
              <input name="enBody" type="text" value="{{$campaign->enBody}}">
