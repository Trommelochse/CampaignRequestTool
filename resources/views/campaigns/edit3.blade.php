...
<div class="wrapper">
    <form action="{{route('updateCreative', $campaign->id)}}" data-abide novalidate method="POST">
        <fieldset class="borderFieldset">
            ...
            <div class="row">
                <div class="large-12 columns">
                    ...
                    <textarea rows="8" name="creativeBody" id="campaignCreativeBrief" type="text" required>{{$campaign->creativeBody}}</textarea>
            ...
            <div class="row">
                ...
                <div class="large-3 columns">
                    <input id="channelOnsite" type="checkbox" class="revealer" name="onsite" value=1 {{ $campaign->onsite ? 'checked' : '' }}>
                ...
                <div class="large-9 columns hiddenField">
                    ...
                    <textarea rows="3" id="channelOnsiteBrief" name="onsiteBody" data-abide-ignore>{{$campaign->onsiteBody}}</textarea>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelLP" type="checkbox" class="revealer" name="lp" value=1 {{ $campaign->lp ? 'checked' : '' }}>
                    <label for="channelLP">Landing Page</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelLPURL">Landing Page Desired URL*</label>
                    <input id="channelLPURL" type="text" name="lpUrl" value="{{$campaign->lpUrl}}">
                    ...
                    <input id="channelLPRef" type="text" name="lpSimilar" data-abide-ignore value="{{$campaign->lpSimilar}}">
                    ...
                    <textarea rows="3" id="channelLPBrief" name="lpBody">{{$campaign->lpBody}}</textarea>
                    <span class="form-error">This field cannot be left blank</span>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelEmail" type="checkbox" class="revealer" name="nl" value=1 {{ $campaign->nl ? 'checked' : '' }}>
                    <label for="channelEmail">Email Sendout</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelEmailBrief">Email Sendout Brief</label>
                    <textarea rows="3" id="nlBody" name="nlBody" data-abide-ignore>{{$campaign->nlBody}}</textarea>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelOMS" type="checkbox" class="revealer" name="oms" value=1 {{ $campaign->oms ? 'checked' : '' }}>
                    <label for="channelOMS">OMS (Onsite Message)</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelOMSBrief">OMS (Onsite Messaging) Brief</label>
                    <textarea rows="3" id="channelOMSBrief" name="omsBody" data-abide-ignore>{{ $campaign->omsBody}}</textarea>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="SMS" type="checkbox" class="revealer" name="sms" value=1 {{ $campaign->sms ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelPush" type="checkbox" class="revealer" name="push" value=1 {{ $campaign->push ? 'checked' : '' }}>
                    <label for="channelPush">Push Notifications</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelPushBrief">Push Notifications Brief</label>
                    <textarea rows="3" id="channelPushBrief" name="pushBody" data-abide-ignore>{{ $campaign->push}}</textarea>
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelBlog" type="checkbox" class="revealer" name="blog" value=1 {{ $campaign->blog ? 'checked' : '' }}>
                    <label for="channelBlog">Blog Post</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelBlogBrief">Blog Post Brief*</label>
                    <textarea rows="3" id="channelBlogBrief" name="blogBody"{{ $campaign->blogBody }}></textarea>
                    <span class="form-error">This field cannot be left blank</span>
                    ...
                    <input id="channelBlogCategoryTags" type="text" name="blogCategory" data-abide-ignore value="{{ $campaign->blogCategory}}">
            ...
            <div class="row">
                <div class="large-3 columns">
                    <input id="channelSocial" type="checkbox" class="revealer" name="some" value=1 {{ $campaign->some ? 'checked' : '' }}>
                    <label for="channelSocial">Social Media</label>
                </div>
                <div class="large-9 columns hiddenField">
                    <label for="channelSocialBrief">Social Media Brief</label>
                    <textarea rows="3" id="channelSocialBrief" name="someBody">{{ $campaign->someBody ? 'checked' : '' }}</textarea>
                    <span class="form-error">This field cannot be left blank</span>
            ...
            <div class="row">
                ...
                <div class="medium-6 columns">
                    <input name="aff" value=1 id="channelAffiliates" type="checkbox" class="campaignChannel" {{ $campaign->aff ? 'checked' : '' }}>
                    <label for="channelAffiliates">Affiliate Banners</label>
                </div>
                <div class="medium-6 columns">
                    <input name="extba" value=1 id="channelExternalBanners" type="checkbox" class="campaignChannel" {{ $campaign->extba ? 'checked' : '' }}>
                    <label for="channelExternalBanners">Other External Banners</label>
                </div>
                <div class="medium-6 columns">
                    <input name="lbm" value=1 id="channelLBM" type="checkbox" class="campaignChannel" {{ $campaign->lbm ? 'checked' : '' }}>
                    <label for="channelLBM">Local Campaign - (LBMs)</label>
                </div>
                <div class="medium-6 columns">
                    <input name="print" value=1 id="channelPrint" type="checkbox" class="campaignChannel" {{ $campaign->print ? 'checked' : '' }}>
                    <label for="channelPrint">Print</label>
                </div>
                <div class="medium-6 columns">
                    <input name="dm" value=1 id="channelDirectMail" type="checkbox" class="campaignChannel" {{ $campaign->dm ? 'checked' : '' }}>
                    <label for="channelDirectMail">Direct Mailer</label>
                </div>
                <div class="medium-6 columns">
                    <input name="tvc" value=1 id="channelTVC" type="checkbox" class="campaignChannel" {{ $campaign->tvc ? 'checked' : '' }}>
