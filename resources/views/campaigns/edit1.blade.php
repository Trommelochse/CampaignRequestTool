...
<div class="wrapper">
  <form method="POST" action="{{route('updateCampaign', $campaign->id)}}">
    <fieldset class="borderFieldset">
      ...
      <div class="row">
        <div class="large-12 medium-12 columns">
          ...
          <fieldset class="alwaysActive">
            <input type="radio" name="segment" value="Acquisition" id="segmentAcquisition" required {{$campaign->segment == 'Acquisition' ? 'checked' : ''}}>
            <label for="segmentAcquisition">Acquisition</label>
            <input type="radio" name="segment" value="Retention" id="segmentRetention" {{$campaign->segment == 'Retention' ? 'checked' : ''}}>
            <label for="segmentRetention">Retention</label>
            <input type="radio" name="segment" value="Acquisition and Retention" id="segmentBoth" {{$campaign->segment == 'Acquisition and Retention' ? 'checked' : ''}}>
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <textarea rows="6" name="body" aria-describedby="bodyHelpText" required data-live-validate>{{$campaign->body}}</textarea>
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <input type="text" name="type" aria-describedby="typeHelpText" required data-live-validate value="{{$campaign->type}}">
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <input type="text" name="relatedCampaign" aria-describedby="relatedCampaignHelpText" data-abide-ignore value="{{$campaign->relatedCampaign}}"/>
      ...
      <div class="row">
        ...
        <div class="large-9 columns">
          ...
          <div class="large-4 columns">
            <div class="large-12">
              <input id="productSB" type="checkbox" name="sb" value=1 {{$campaign->sb ? 'checked' : ''}}>
              <label for="productSB">Sportsbook</label>
            </div>
            <div class="large-12">
              <input id="productCA" type="checkbox" name="ca" value=1 {{$campaign->ca ? 'checked' : ''}}>
              <label for="productCA">Casino</label>
            </div>
            <div class="large-12">
              <input id="productVCA" type="checkbox" name="vca" value=1 {{$campaign->vca ? 'checked' : ''}}>
              <label for="productVCA">Vegas Casino</label>
            </div>
            <div class="large-12">
              <input id="productLCA" type="checkbox" name="lca" value=1 {{$campaign->lca ? 'checked' : ''}}>
              <label for="productLCA">Live Casino</label>
            </div>
          </div>
          <div class="large-4 columns float-left">
            <div class="large-12">
              <input id="productVS" type="checkbox" name="vs"  value=1 {{$campaign->vs ? 'checked' : ''}}>
              <label for="productVS">Virtual Sports</label>
            </div>
            <div class="large-12">
              <input id="productPK" type="checkbox" name="pk"  value=1 {{$campaign->pk ? 'checked' : ''}}>
              <label for="productPK">Poker</label>
            </div>
            <div class="large-12">
              <input id="productMX" type="checkbox" name="mx"  value=1 {{$campaign->mx ? 'checked' : ''}}>
              <label for="productMX">MX (Cross-Sell)</label>
            </div>
            <div class="large-12">
              <input id="productIN" type="checkbox" name="in" value=1 {{$campaign->in ? 'checked' : ''}}>
        ...
        <div class="large-3 columns alwaysActive">
          ...
          <div class="large-12">
            <input id="platformMOB" type="checkbox" name="mw" value=1 {{$campaign->mw ? 'checked' : ''}}>
            <label for="platformMOB">Mobile Web</label>
          </div>
          <div class="large-12">
            <input id="platformNAT" type="checkbox" name="native" value=1 {{$campaign->native ? 'checked' : ''}}>
            <label for="platformNAT">Mobile Native</label>
          </div>
          <div class="large-12">
            <input id="platformWEB" type="checkbox" name="web" value=1 {{$campaign->web ? 'checked' : ''}}> 
      ...
      <div class="row">
        <div class="large-12 medium-12 columns">
          ...
          <fieldset class="alwaysActive">
            <input type="radio" name="meeting" value=1 id="meetingYes" required {{$campaign->meeting ? 'checked' : ''}}>
            <label for="meetingYes">Yes</label>
            <input type="radio" name="meeting" value=0 id="meetingNo" {{!$campaign->meeting ? 'checked' : ''}}>
      ...
      <div class="row">
        ...
        <div class="large-6 columns">
          ...
          <input type="text" class="dp1" name="startDate" required data-live-validate value="{{$campaign->startDate}}"/>
          <span class="form-error"> Please enter a Campaign Start Date </span> </div>
        <div class="large-6 columns">
          <label>End Date (UTC)*</label>
          <input type="text" placeholder="" class="dp1" name="endDate" required data-live-validate value="{{$campaign->endDate}}"/>
          <span class="form-error"> Please enter a Campaign End Date </span> </div>
      </div>
      <div class="row">
        <div class="large-12 columns">
          <input class="revealer" id="campaignRecurring" type="checkbox" name="recurring" value=1 data-abide-ignore {{$campaign->recurring ? 'checked' : ''}} >
        ...
        <div class="large-4 float-left columns hiddenField">
          ...
          <input type="text" name="recurringBody" value="{{$campaign->recurringBody}}" />
