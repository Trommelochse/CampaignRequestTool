...
$('#reviewButton').click(function() {
    $('.reviewSectionButtons').show();
});

$('.approveButton').click(function() {
    $(this).parent().prev().removeClass('reviewRejected').addClass('reviewApproved');
    $(this).parent('.reviewSectionButtons').hide();
});

$('.rejectButton').click(function() {
    $(this).parent().prev().removeClass('reviewApproved').addClass('reviewRejected');
    $(this).parent('.reviewSectionButtons').hide();
});

$('#saveReviewButton').click(function() {
    $('.reviewSectionButtons').hide();
});
